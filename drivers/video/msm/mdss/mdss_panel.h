...
struct mdss_panel_data {
	...
	void (*set_sunlightreadable)(struct mdss_panel_data *pdata, u32 enable_sre);
	/* CEI sam add for read panel id */
	void (*get_panel_id)(struct mdss_panel_data *pdata, char *rx_buf);
	/* CEI sam add to read cabc */
	void (*get_cabc)(struct mdss_panel_data *pdata, char *rx_buf);
