...
#define HIMAX_DRIVER_VER "0.1.7.0"
...
static u8 		HW_RESET_ACTIVATE 	= 1;
	...
	//CEI factory Define Start
	#define HIMAX_PROC_FW_VERSION		"fw_version" //20160119 for CEI factory
	#define HIMAX_PROC_CHECK_FW_VERSION	"check_fw_version" //20160119 for CEI factory
	#define HIMAX_PROC_ENABLE_TP		"enable_tp" //20160119 for CEI factory
	#define HIMAX_PROC_DISABLE_TP		"disable_tp" //20160119 for CEI factory
	#define HIMAX_PROC_TOUCH_TP_IC		"touch_tp_ic" //20160119 for CEI factory
	//CEI factory Define End
	...
	//CEI factory Define Start
	static struct proc_dir_entry *himax_proc_fw_version 		= NULL; //20160119 for CEI factory
	static struct proc_dir_entry *himax_proc_check_fw_version	= NULL; //20160119 for CEI factory
	static struct proc_dir_entry *himax_proc_enable_tp		= NULL; //20160119 for CEI factory
	static struct proc_dir_entry *himax_proc_disable_tp		= NULL; //20160119 for CEI factory
	static struct proc_dir_entry *himax_proc_touch_tp_ic		= NULL; //20160119 for CEI factory
	//CEI factory Define End
